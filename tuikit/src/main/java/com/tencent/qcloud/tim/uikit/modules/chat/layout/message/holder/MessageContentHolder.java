...
public abstract class MessageContentHolder extends MessageEmptyHolder {
    ...
    private ColorStateList mRintFrameColor;
    private ColorStateList mLeftFrameColor;
    ...
    public void layoutViews(final MessageInfo msg, final int position) {
        ...
        if (msg.isSelf()) {
            if (properties.getRightBubble() != null && properties.getRightBubble().getConstantState() != null) {
                ...
                if(mRintFrameColor == null){
                   mRintFrameColor=ColorStateList.valueOf(ResourceUtil.getColor(R.color.global));
                }
                if(msgContentFrame.getBackgroundTintList()!=mRintFrameColor){
                   msgContentFrame.setBackgroundTintList(mRintFrameColor);
                }
            } else {
                msgContentFrame.setBackgroundResource(R.drawable.chat_bubble_myself);
            }
            ...
            if (properties.getLeftBubble() != null && properties.getLeftBubble().getConstantState() != null) {
                ...
                if(mLeftFrameColor == null){
                   mLeftFrameColor=ColorStateList.valueOf(ResourceUtil.getColor(R.color.white));
                }
                if(msgContentFrame.getBackgroundTintList()!=mLeftFrameColor){
                    msgContentFrame.setBackgroundTintList(mLeftFrameColor);
                }
                msgContentFrame.setBackgroundTintList(mLeftFrameColor);
