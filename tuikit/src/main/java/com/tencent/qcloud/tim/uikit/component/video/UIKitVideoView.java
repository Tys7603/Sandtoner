...
public class UIKitVideoView extends TextureView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = getDefaultSize((int) mVideoWidth, widthMeasureSpec);
        int height = getDefaultSize((int) mVideoHeight, heightMeasureSpec);
        ...
        if (mVideoWidth > 0 && mVideoHeight > 0) {
            if (widthSpecMode == MeasureSpec.EXACTLY && heightSpecMode == MeasureSpec.EXACTLY) {
                ...
                width = widthSpecSize;
                height = (int) ((int) width*(mVideoHeight / mVideoWidth));
        ...
        L.e("onMeasure width: " + width + " height: " + height + " rotation degree: " + mVideoRotationDegree);
        setMeasuredDimension(width, height);
        int range=(mVideoRotationDegree + 180) % 180;
        if ( range!= 0) {
