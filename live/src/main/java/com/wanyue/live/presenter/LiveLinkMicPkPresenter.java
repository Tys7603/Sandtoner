...
public class LiveLinkMicPkPresenter implements View.OnClickListener {
    ...
    /**
     * Instantiates a new Live link mic pk presenter.
     *
     * @param context           the context
     * @param linkMicViewHolder the link mic view holder
     * @param isAnchor          the is anchor
     * @param root              the root
     */
     ...
     * pk 进度发送变化
     *
     * @param leftGift  the left gift
     * @param rightGift the right gift
     */
     ...
     * Sets self stream.
     *
     * @param selfStream the self stream
     */
