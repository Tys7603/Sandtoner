...
//                    builder.append(bean.getContent());
    ...
    /**
     * Render gift info 2 spannable string builder.
     *
    ...
    /**
     * Render gift info spannable string builder.
     *
     * @param giftCount the gift count
     * @param giftName  the gift name
     * @return the spannable string builder
     */
    ...
    /**
     * Render gift count spannable string builder.
     *
