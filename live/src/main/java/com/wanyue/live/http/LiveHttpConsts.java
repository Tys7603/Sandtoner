...
public class LiveHttpConsts {
    ...
    public static final String GET_LIVE_END_INFO = "live/stopinfo";
    public static final String SET_REPORT = "setReport";
    public static final String GET_LIVE_REPORT_LIST = "getLiveReportList";
    public static final String GET_LIVE_USER = "pop";
    public static final String KICKING = "livekick";
    public static final String SET_SHUT_UP = "liveshut";
    public static final String SET_SHUT_CANCLE = "liveunshut";
    ...
    public static final String CREATE_ROOM = "live/start";
    public static final String CHANGE_LIVE = "live/upLive";
    public static final String STOP_LIVE = "live/stop";
    public static final String GET_LIVE_SDK = "getLiveSdk";
    public static final String GET_LIVE_CLASS = "live/class";
    ...
    public static final String ANCHOR_CHECK_LIVE = "checklive";
    ...
    public static final String GET_SALE = "shopsale";

    public static final String SET_SALE = "setsale";
    public static final String SEARCH_LIVE_GOODS_LIST = "shoplist";
    public static final String LIVE_QR_CODE = "live/qr";
    public static final String LIVE_NUMS = "livenums";
    public static final String LIVE_LIKES = "livelikes";
    public static final String SET_LIVE_LIKES = "livesetlike";


    public static final String SHOP_SALE_NUMS = "shopsalenums";
    public static final String GET_SHOP_LIST = "shoplist";
    public static final String GET_USER_NUMS="livenums";
    public static final String GET_LIVE_LIKES="livelikes";
    public static final String LIVE_GOODS_NUMS="livegoodsnums";
