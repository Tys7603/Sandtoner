...
public class LiveHttpUtil {
    ...
    public static void createRoom(String title, int liveClassId, String thumb,String key, HttpCallback callback) {
    ...
    public static Observable<List<LiveClassBean>> getLiveClassList() {
        return RequestFactory.getRequestManager().get(LiveHttpConsts.GET_LIVE_CLASS, null, LiveClassBean.class, false);
    }
