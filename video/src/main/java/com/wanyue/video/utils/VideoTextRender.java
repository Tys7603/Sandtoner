package com.wanyue.video.utils;
...
public class VideoTextRender {
    ...
    public static CharSequence getFaceImageSpan(String content, int imgRes) {
        ...
        Drawable faceDrawable = ContextCompat.getDrawable(CommonApplication.sInstance, imgRes);
    ...
    public static CharSequence renderVideoComment2(String content, String name) {
        SpannableStringBuilder builder = new SpannableStringBuilder(name).append(":").append(content);
