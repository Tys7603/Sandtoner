...
public class VideoCommentAdapter extends RefreshAdapter<VideoCommentBean> {
    ...
    public VideoCommentAdapter(Context context) {
        ...
        mLikeCommentCallback = new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (isSuccess(code) && mCurLikeCommentBean != null) {
                    JSONObject obj = JSON.parseObject(info[0]);
                    String likeNum = obj.getString("likes");
                    if (mCurLikeCommentBean != null) {
                        mCurLikeCommentBean.margeLikeChange();
        ...
        mLikeClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(uid) && uid.equals(CommonAppConfig.getUid())) {
                ...
                int targetType=bean.getIsLike()==1?0:1;
                bean.setTargetLike(targetType);
                VideoAPI.setCommentLike(bean.getId(), targetType,mLikeCommentCallback);
            }
        };
    ...
    class ChildVh extends RecyclerView.ViewHolder {
        ...
        void setData(VideoCommentBean bean, Object payload) {
            ...
            mContent.setText(VideoTextRender.renderVideoComment2(bean.getContent(),bean.getNickname()));
