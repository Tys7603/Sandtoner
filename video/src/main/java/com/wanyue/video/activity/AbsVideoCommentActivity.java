...
import com.wanyue.video.dialog.VideoInputDialogFragment;
import com.wanyue.video.views.VideoCommentViewHolder;
...
public abstract class AbsVideoCommentActivity extends AbsActivity implements View.OnClickListener, OnFaceClickListener {
     ...
     * 显示评论
     */
    public void openCommentWindow(String videoId, String videoUid,String totalNum) {
        ...
        mVideoCommentViewHolder.setCommentNum(totalNum);
