...
public class FullScreenPlayer extends AbsPlayer implements View.OnClickListener,
    ...
    private void initView(Context context) {
        ...
        mBtnToWidow= (ImageView) findViewById(R.id.btn_to_window);
        ...
        mBtnToWidow.setOnClickListener(this);
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == R.id.superplayer_iv_back || i == R.id.superplayer_tv_title||i == R.id.btn_to_window) { //顶部标题栏
            if (mControllerCallback != null) {
            ...
            seekToKeyFramePos();
        }else if(i==R.id.superplayer_tv_speed){
            changeSpeed();
        }
    }
