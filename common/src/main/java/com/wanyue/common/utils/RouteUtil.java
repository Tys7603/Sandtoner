...
public class RouteUtil {
    ...
    public static final String PATH_GOODS_DETAIL = "/shop/GoodDetail";

    public static final String PATH_GOODS_LIVE = "/main/GoodLive";
    ...
    public static void forwardGoodsDetail(String id) {
        ARouter.getInstance().build(PATH_GOODS_DETAIL)
                .withString(Constants.KEY_ID,id)
                .navigation();
    }

    public static void forwardGoodsDetailNoCart(String id,String liveUid) {
        ARouter.getInstance().build(PATH_GOODS_DETAIL)
                .withString(Constants.KEY_ID,id)
                .withString(Constants.LIVE_UID,liveUid)
                .withSerializable(Constants.KEY_STATUS,1)
                .navigation();
    }
    ...
    //商品关联直播
    public static void forwardGoodsAboutLive(String id) {
        ARouter.getInstance().build(PATH_GOODS_LIVE)
                .withString(Constants.KEY_ID,id)
                .navigation();
    }
