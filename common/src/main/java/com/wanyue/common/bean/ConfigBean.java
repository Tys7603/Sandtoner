...
public class ConfigBean {
    ...
    @SerializedName("beauty_android")
    @JSONField(name = "beauty_android")
    ...
    @JSONField(name="tx_sdkappid")
    @SerializedName("tx_sdkappid")
    private int txSdkappid;
    ...
    public String[] getVideoShareTypes() {
        if(shareType==null){
           shareType=new String[]{Constants.MOB_WX,Constants.MOB_WX_PYQ};
        }
        return shareType;
    }
    ...
    public int getTxSdkappid() {
        return txSdkappid;
    }

    public void setTxSdkappid(int txSdkappid) {
        this.txSdkappid = txSdkappid;
    }
}
