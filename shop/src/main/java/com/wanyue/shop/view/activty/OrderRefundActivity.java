...
public class OrderRefundActivity extends BaseActivity implements View.OnClickListener, BaseMutiRecyclerAdapter.OnItemChildClickListener2<SelectPhotoBean>, BaseQuickAdapter.OnItemClickListener {
    ...
    public void init() {
        ...
        mRecyclerView.setAdapter(mSelectImageAdapter);
    ...
    private void goToSelectPhoto() {
        judgePermisson(new Runnable() {
            ...
            public void run() {
                ...
                SelectPhotoActivity.forward(OrderRefundActivity.this,list,MAX_PHOTO_LENGTH);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(mRefundCommitBean!=null){
           mRefundCommitBean.setPhotoList(list);
        }
    }
