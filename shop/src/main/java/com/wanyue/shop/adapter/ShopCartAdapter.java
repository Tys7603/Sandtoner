...
public class ShopCartAdapter <T extends MultiItemEntity> extends BaseMutiRecyclerAdapter<T, BaseReclyViewHolder>{
    ...
    /**
     * Instantiates a new Shop cart adapter.
     *
     * @param data             the data
     * @param baseProxyMannger the base proxy mannger
     * @param context          the context
     * @param shopCartModel    the shop cart model
     */
    ...
    /**
     * Sets delete invaild listner.
     *
     * @param deleteInvaildListner the delete invaild listner
     */
    ...
    /**
     * The interface Delete invaild listner.
     */
