...
public class CalendarView extends FrameLayout {
    ...
    public final void setSelectStartCalendar(int startYear, int startMonth, int startDay) {
        ...
        startCalendar.setMonth(startMonth+1);
        startCalendar.setDay(startDay);
        if(mDelegate.mInnerListener!=null){
            mDelegate.mInnerListener.onMonthDateSelected(startCalendar,true);
            mDelegate.mInnerListener.onWeekDateSelected(startCalendar,true);
        }
    }
