...
public class MhMakeupViewHolder extends AbsMhChildViewHolder implements View.OnClickListener, OnItemClickListener<MakeupBean> {
    ...
    public void init() {
        ...
        beans.add(new MakeupBean(R.string.beauty_mh_makeup_none, R.mipmap.ic_makeup_no_0, R.mipmap.ic_makeup_no_1, MHSDK.MAKEUP_NONE,MHConfigConstants.MEI_ZHUANG_YUAN_TU));
        beans.add(new MakeupBean(R.string.beauty_mh_makeup_jiemao, R.mipmap.ic_makeup_jiemao_0, R.mipmap.ic_makeup_jiemao_1,MHSDK.MAKEUP_EYELASH,MHConfigConstants.MEI_ZHUANG_JIE_MAO));
        beans.add(new MakeupBean(R.string.beauty_mh_makeup_chuncai, R.mipmap.ic_makeup_chuncai_0, R.mipmap.ic_makeup_chuncai_1,MHSDK.MAKEUP_LIPSTICK,MHConfigConstants.MEI_ZHUANG_CHUN_CAI));
        beans.add(new MakeupBean(R.string.beauty_mh_makeup_saihong, R.mipmap.ic_makeup_saihong_0, R.mipmap.ic_makeup_saihong_1,MHSDK.MAKEUP_BLUSH,MHConfigConstants.MEI_ZHUANG_SAI_HONG));
