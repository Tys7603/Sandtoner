...
public class MhTeXiaoActionViewHolder extends MhTeXiaoChildViewHolder implements OnItemClickListener<TeXiaoActionBean> {
    ...
    public void init() {
        ...
        beans.add(new TeXiaoActionBean(R.string.beauty_mh_texiao_action_head, R.mipmap.ic_texiao_action_taitou_0, R.mipmap.ic_texiao_action_taitou_1,"",MHSDK.TE_XIAO_ACTION_TAI_TOU,MHConfigConstants.TE_XIAO_DONG_ZUO_TAI_TOU));
        beans.add(new TeXiaoActionBean(R.string.beauty_mh_texiao_action_mouth, R.mipmap.ic_texiao_action_zhangzui_0, R.mipmap.ic_texiao_action_zhangzui_1,"",MHSDK.TE_XIAO_ACTION_ZHANG_ZUI,MHConfigConstants.TE_XIAO_DONG_ZUO_ZHANG_ZUI));
        beans.add(new TeXiaoActionBean(R.string.beauty_mh_texiao_action_eye, R.mipmap.ic_texiao_action_zhayan_0, R.mipmap.ic_texiao_action_zhayan_1,"",MHSDK.TE_XIAO_ACTION_ZHA_YAN,MHConfigConstants.TE_XIAO_DONG_ZUO_ZHA_YAN));
